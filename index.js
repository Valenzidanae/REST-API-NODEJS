...
// penggunaan body-parser untuk ekstrak data request berfotmat JSON
...
app.get("/test", (req,res) => {
    ...
    // membuat objek yang berisi data yang dijadikan response
    let response = {
        message: "ini end-point pertama shasha",
        method: req.method,
        code: res.statusCode
    }
...
app.get("/profil/:name/:age", (req,res) => {
    ...
    // bersifat dinamis yang dapat diganti nilainya saatmelakukan request
